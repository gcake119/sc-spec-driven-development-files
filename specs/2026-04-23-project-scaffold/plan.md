...
3. Add `test` and `test:validation` scripts and confirm validation tests execute in a clean environment.
...
5. Add responsive layout and typography rules for mobile, tablet, and desktop viewports.
...
3. Verify home page responsive behavior at representative breakpoints (320px, 768px, 1024px+).
4. Document anything intentionally deferred to later phases.
